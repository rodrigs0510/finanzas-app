...
# --- CSS SUPERFICIES Y BOTONES (V16.0) ---
st.markdown(f"""
<style>
    /* 1. FONDO DE PANTALLA */
    .stApp {{
    ...
    /* 2. SUPERFICIE SÓLIDA PARA LAS SECCIONES (LA SOLUCIÓN AL TRANSPARENTE) */
    div[data-testid="stVerticalBlockBorderWrapper"] {{
        background-color: #FFF8DC !important; /* Beige 'Cornsilk' Sólido */
    ...
    /* Forzar que el contenido dentro no sea transparente */
    div[data-testid="stVerticalBlockBorderWrapper"] > div {{
        background-color: transparent !important;
    }}

    /* 3. TEXTOS NEGROS/MARRONES PARA LEER BIEN */
    ...
    /* 6. BOTONES ESTILO PASTILLA (RECREADOS CON CSS PARA QUE NO DESAPAREZCAN) */
    
    /* Botón AGREGAR (Verde) */
    div.stButton > button:has(p:contains('Agregar')) {{
        background-color: #A2D149 !important; /* Verde Manzana */
        color: #2F4F4F !important; /* Letra oscura */
        border: 3px solid #556B2F !important; /* Borde Verde Oscuro */
        border-radius: 50px !important;
        font-weight: 900 !important;
        font-size: 18px !important;
        padding: 10px !important;
        box-shadow: 0 4px 0 #556B2F !important; /* Efecto 3D */
    }}
    div.stButton > button:has(p:contains('Agregar')):active {{
    ...
    div.stButton > button:has(p:contains('Eliminar')) {{
        ...
        color: #581818 !important; /* Letra oscura */
        border: 3px solid #8B0000 !important; /* Borde Rojo Oscuro */
        border-radius: 50px !important;
        font-weight: 900 !important;
        font-size: 18px !important;
        padding: 10px !important;
    ...
    div.stButton > button:has(p:contains('Eliminar')):active {{
        box-shadow: none !important;
        transform: translateY(4px) !important;
    }}
...
# ==============================================================================
with st.container(border=True): # ESTA CAJA SERÁ BEIGE SÓLIDA
...
with st.container(border=True): # CAJA BEIGE SÓLIDA
